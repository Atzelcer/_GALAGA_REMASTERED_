...
public:
    ...
    // Agregar las propiedades para los audios de la historia
    UPROPERTY(EditDefaultsOnly, Category = "Audio")
    TArray<class USoundBase*> HistorySounds;

    UPROPERTY(EditDefaultsOnly, Category = "Audio")
    class UAudioComponent* HistoryAudioComponent;

    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Audio")
    class UAudioComponent* AudioComponentTransion;

    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Root")
    class USoundBase* RootTransion;

    int32 CurrentAudioIndex = 0;
    ...
    void PlayNextHistoryAudio();
    void StopHistoryAudio();

    void OnContinueHistoryClicked();
    void OnSkipHistoryClicked();
